mod setup {
    ...
    use zkastle::models::player::Player;
    use zkastle::systems::actions::{actions, IActions, IActionsDispatcher, IActionsDispatcherTrait};
    ...
    fn spawn_game() -> (IWorldDispatcher, Systems, Context) {
        ...
        models.append(zkastle::models::index::game::TEST_CLASS_HASH);
        models.append(zkastle::models::index::player::TEST_CLASS_HASH);
