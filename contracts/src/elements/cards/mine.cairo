...
impl CardImpl of CardTrait {
    ...
    fn resource(side: Side) -> Resource {
        match side {
            Side::Two => ResourceTrait::new(0, 0, 1),
            Side::Three => ResourceTrait::new(0, 0, 1),
            Side::Four => ResourceTrait::new(0, 0, 2),
    ...
    fn cost(side: Side, action: Action) -> Array<Resource> {
        match action {
            Action::Rotate => match side {
                ...
                Side::Three => array![ResourceTrait::new(2, 1, 0)],
                _ => array![],
            },
            Action::Flip => match side {
                Side::One => array![ResourceTrait::new(2, 0, 0)],
                Side::Two => array![ResourceTrait::new(1, 2, 0)],
                _ => array![],
            },
            _ => array![],
        }
